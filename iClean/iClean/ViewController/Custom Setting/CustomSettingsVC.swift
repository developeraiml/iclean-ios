...
class CustomSettingsVC: BaseViewController {
    ...
    fileprivate func finalStepWashSetting() {
        ...
        let vc = storyboard?.instantiateViewController(withIdentifier: "RegWashSettingListVC") as? WashSettingListVC
...
extension CustomSettingsVC: UITableViewDataSource, UITableViewDelegate {
...
extension CustomSettingsVC: UITextViewDelegate {
