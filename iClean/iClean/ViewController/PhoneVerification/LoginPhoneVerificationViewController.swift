...
class LoginPhoneVerificationViewController: BaseViewController {
...
extension LoginPhoneVerificationViewController {
    
    func showAddLocation() {
        
        DispatchQueue.main.async {
            
            guard let addLocation = self.storyboard?.instantiateViewController(withIdentifier: "RegAddLocationVC") as? AddLocationViewController else {
                return
            }
...
extension LoginPhoneVerificationViewController: UITextFieldDelegate {
...
extension LoginPhoneVerificationViewController: UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: GeneralConstants.phoneVerifyCell) as? phoneVerificationCell
