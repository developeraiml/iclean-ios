...
class ChangeEmailPasswordViewController: BaseViewController,UITextFieldDelegate {
...
extension ChangeEmailPasswordViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: GeneralConstants.emailPasswordCell) as? ChangeEmailPasswordCell
