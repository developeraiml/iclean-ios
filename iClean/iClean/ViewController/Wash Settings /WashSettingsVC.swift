...
class WashSettingsVC: BaseViewController {
    ...
    func openCustomSettings() {
        guard let customVC = storyboard?.instantiateViewController(withIdentifier: "RegCustomSettingsVC") as? CustomSettingsVC else {
            return
        }
...
extension WashSettingsVC: UITableViewDataSource, UITableViewDelegate {
