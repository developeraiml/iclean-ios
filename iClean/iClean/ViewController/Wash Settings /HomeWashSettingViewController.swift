...
class HomeWashSettingViewController: BaseViewController {
...
extension HomeWashSettingViewController: UITableViewDataSource, UITableViewDelegate {
...
extension HomeWashSettingViewController {
    
    func openCustomSettings() {
        guard let customVC = storyboard?.instantiateViewController(withIdentifier: "CustomSettingsVC") as? CustomSettingsViewController else {
            return
        }
