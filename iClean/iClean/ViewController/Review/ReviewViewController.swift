...
class ReviewViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            ...
            if indexPath.row == 0 {
                let cardCell = tableView.dequeueReusableCell(withIdentifier: "ReviewCardCell") as? ReviewCardCell
                ...
                let tipCell = tableView.dequeueReusableCell(withIdentifier: "ReviewTipsCell") as? ReviewTipsCell
            ...
            let pickCell = tableView.dequeueReusableCell(withIdentifier: "reviewCell") as? OrderDetailsCell
            ...
            let washCell = tableView.dequeueReusableCell(withIdentifier: "ReviewWashSettingsCell") as? FaqTableViewCell
