...
class AddLocationVC: BaseViewController {
    ...
    fileprivate func showCreditCard() {
            ...
            DispatchQueue.main.async {
                ...
                guard let addLocation = self.storyboard?.instantiateViewController(withIdentifier: "RegAddCardVC") as? AddCardVC else {
                    return
                }
...
extension AddLocationVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            let cell = tableView.dequeueReusableCell(withIdentifier: "LocationInfoCell") as? LocationInfoCell
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "LocationStateCell") as? LocationStateCell
